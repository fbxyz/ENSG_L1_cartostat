...
knitr::include_graphics("./assets/images/3-Discrétisation/cont_disc.png")
```
] 
...
knitr::include_graphics("./assets/images/3-Discrétisation/principe_1a.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="75%"}
knitr::include_graphics("./assets/images/3-Discrétisation/principe_1b.png")
```
] 
...
.center-img[
```{r echo=FALSE, out.width="75%"}
knitr::include_graphics("./assets/images/3-Discrétisation/principe_2a.png")
```
] 
...
.center-img[
```{r echo=FALSE, out.width="75%"}
knitr::include_graphics("./assets/images/3-Discrétisation/principe_2b.png")
```
] 
...
.center-img[
```{r echo=FALSE, out.width="75%"}
knitr::include_graphics("./assets/images/3-Discrétisation/principe_2c.png")
```
] 
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/3-Discrétisation/icf_ex.png")
```
] 
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/3-Discrétisation/message.png")
```
] 
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/3-Discrétisation/clc.png")
```
]
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/3-Discrétisation/sang_cordon.png")
```
]]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/3-Discrétisation/discret_paris.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/3-Discrétisation/suivre_ex1.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/3-Discrétisation/regles.png")
```
]
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/3-Discrétisation/gb.jpg")
```
]]
...
knitr::include_graphics("./assets/images/3-Discrétisation/yes.gif")
knitr::include_graphics("./assets/images/3-Discrétisation/yes2.gif")
knitr::include_graphics("./assets/images/3-Discrétisation/yes3.gif")
```
]]
...
knitr::include_graphics("./assets/images/3-Discrétisation/absolue.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="90%"}
knitr::include_graphics("./assets/images/3-Discrétisation/relatif.png")
```
]
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/3-Discrétisation/forme_distrib.png")
```
]
