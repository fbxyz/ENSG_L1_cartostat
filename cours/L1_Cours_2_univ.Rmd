...
.center-img[
```{r echo=FALSE, out.width="70%"}
knitr::include_graphics("./assets/images/2-Stat/plotly-example-plots.png")
```
] 
...
.center-img[
```{r echo=FALSE, out.width="70%"}
knitr::include_graphics("./assets/images/2-Stat/histo.png")
```
] 
...
knitr::include_graphics("./assets/images/2-Stat/histo-barre.png")
```
] 
...
.center-img[
```{r echo=FALSE, out.width="70%"}
knitr::include_graphics("./assets/images/2-Stat/billou.png")
```
] 
...
.center-img[
```{r echo=FALSE, out.width="70%"}
knitr::include_graphics("./assets/images/2-Stat/centrale.png")
```
]
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/2-Stat/loi_normale.png")
```
]]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/2-Stat/var_1.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/2-Stat/var_2.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/2-Stat/var_3.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/2-Stat/var_4.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/2-Stat/var_5.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/2-Stat/var_6.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/2-Stat/var_7.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="90%"}
knitr::include_graphics("./assets/images/2-Stat/quantiles.png")
```
] 
...
.pull-right[.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/2-Stat/boxplot.png")
```
]]
...
knitr::include_graphics("./assets/images/2-Stat/skew.png")
```
] ]
...
.pull-right[ .center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/2-Stat/applat.png")
```
] ]
