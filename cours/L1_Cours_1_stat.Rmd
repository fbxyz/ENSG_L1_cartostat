...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/2-Stat/simpson.png")
```
]]
...
knitr::include_graphics("./assets/images/2-Stat/flanders.gif")
```
]]
...
.pull-right[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/2-Stat/quanti_quali.png")
```
]]
...
.pull-right[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/2-Stat/taux_stock.png")
```
]]
